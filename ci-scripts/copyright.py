...
"""Checks and/or updates copyright headers in TNG source files.
...
class CopyrightChecker(object):
    ...
    _header = ["", "This code is part of the tng binary trajectory format.", ""]
    _copyright = "Copyright (c) {0}, by the GROMACS development team."
    _footer = """
TNG was orginally written by Magnus Lundborg, Daniel Spångberg and
Rossen Apostolov. The API is implemented mainly by Magnus Lundborg,
Daniel Spångberg and Anders Gärdenäs.
